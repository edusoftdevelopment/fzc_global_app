                    ...
                    children: [
                      if (_isLoading) ...[
                        ...
                        DatePickerComponent(
                          ...
                          onChanged: (selectedDate, formattedDate) {
                            setState(() {
                        ...
                        DropdownSearch<DropDownItem>(
                          ...
                          dropdownDecoratorProps: const DropDownDecoratorProps(
                            dropdownSearchDecoration: InputDecoration(
                              labelText: "Supplier Order",
                              hintText: "Select Supplier Order",
                            ),
                          ),
                          clearButtonProps:
                              const ClearButtonProps(isVisible: true),
                          onChanged: onSupplierOrderChanged,
                          selectedItem: _selectedSupplierOrderID,
                        ),
                        const SizedBox(
                          height: 50,
                        ),
